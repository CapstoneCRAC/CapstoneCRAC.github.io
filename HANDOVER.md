...
- `astro.config.mjs` only when the Cloudflare Pages or custom domain URL changes.
...
5. Add approved media links, static images, or R2 video URLs.
6. Run `pnpm build`.
7. Commit and push.

## Scope Reminder

This first version is a static showcase site deployed on Cloudflare Pages.
