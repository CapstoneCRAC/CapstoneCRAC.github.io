---
title: "Gamified Educational Platform for Mastering Chinese Multi-Syllable Characters"
author: "Huang Xinyu"
year: "2025-2026"
cohortId: "coh3"
order: 3
...
- Bubble-launcher matching between multi-syllable Chinese characters and Pinyin
- Five stages with 100 levels and increasing complexity
- Six characters introduced in each level
- Points and level progression
- Change Words control to avoid blocked matches

## Solving a gameplay deadlock

The report describes a fully playable game: users can select levels, complete stages and accumulate points. It also records the Change Words control as a completed fix for a gameplay deadlock discovered during testing.
